			...
			'layouts' => array(
				...
				'layout_5e72300c836e4' => array(
					...
					'sub_fields' => array(
                        ...
                        array(
							'key' => 'field_5ea198d95f1cd',
							'label' => 'Speed(ms)',
							'name' => 'speed',
							'type' => 'number',
							'instructions' => 'Min = 10(fast) \ Max = 100(slow)',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array(
								'width' => '50',
				...
				'layout_5e836028ae163' => array(
					'key' => 'layout_5e836028ae163',
					'name' => 'block_gallery',
					'label' => 'Gallery',
					'display' => 'block',
					'sub_fields' => array(
                        array(
							'key' => 'field_5ea077a6ef962',
							'label' => 'Background : color',
							'name' => 'bg_color',
							'type' => 'color_picker',
							'instructions' => '',
						...
						array(
							'key' => 'field_5e8361fc9ff91',
							'label' => 'Gallery Name',
							'name' => 'gallery_name',
							'type' => 'text',
							'instructions' => 'Unique id without space',
							'required' => 1,
							'conditional_logic' => 0,
							'wrapper' => array(
								'width' => '',
				...
				'layout_5e9df630299bc' => array(
					...
					'sub_fields' => array(
                        ...
                        array(
							...
							'type' => 'color_picker',
							'instructions' => 'Visible on phone only',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array(
								'width' => '33',
