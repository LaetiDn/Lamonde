<section class="portfolio section-content">
    ...
    <div class="content">
        <p class="description">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ex lorem, hendrerit non aliquam eu, elementum lacinia sem. Nam lectus justo, dignissim et ex at, placerat aliquet erat. Aliquam convallis rutrum odio sed vehicula. Nulla commodo mi purus, eget lobortis elit aliquet nec. Ut blandit, lectus sit amet tincidunt aliquet, nunc felis sodales nulla, id tincidunt nunc odio vel eros. Suspendisse ac varius neque. Nam feugiat eu est id luctus. Nullam augue ante, dignissim et dolor eu, posuere malesuada libero. Integer placerat metus eu elementum sollicitudin. Aenean at nibh id dui bibendum mattis. Ut scelerisque, velit imperdiet viverra vulputate, eros nibh scelerisque mi, id varius nisl lacus in felis. Sed finibus laoreet felis, a venenatis dolor fringilla ac. Morbi lobortis et quam ut tempor. Etiam ac turpis sit amet magna suscipit congue ut eu mauris. Nullam tortor massa, fringilla non quam laoreet, elementum commodo lectus.
        </p>
    </div>
    ...
    <div class="item-wrapper">
        ...
        <a href="https://images.unsplash.com/photo-1543362906-acfc16c67564?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=701&q=80" 
            class="item"
            data-lightbox="gallery1" data-title="My caption">
            <div class="line line--top"></div>
            <div class="line line--bottom"></div>
            <div class="line line--left"></div>
            <div class="line line--right"></div>
            <img src="https://images.unsplash.com/photo-1543362906-acfc16c67564?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=701&q=80" alt="">
        </a>
        <a href="https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80" 
            class="item"
            data-lightbox="gallery1" data-title="My caption">
            <div class="line line--top"></div>
            <div class="line line--bottom"></div>
            <div class="line line--left"></div>
            <div class="line line--right"></div>
            <img src="https://images.unsplash.com/photo-1515003197210-e0cd71810b5f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80" alt="">
        </a>
        <a href="https://images.unsplash.com/photo-1499028344343-cd173ffc68a9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80" 
            class="item"
            data-lightbox="gallery1" data-title="My caption">
            <div class="line line--top"></div>
            <div class="line line--bottom"></div>
